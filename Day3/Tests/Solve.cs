namespace Day4.Tests
{
    ...
    public class Solve
    {
        ...
        public void PopCountConfirm()
        {
            ...
            using (new ScopedTimer(this.testOutputHelper))
            {
                value = solver.Solve(new Data(new[]
                {
                    "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51",
                    "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
                }));

                Assert.Equal(135, value.Distance);
            }

            this.testOutputHelper.WriteLine($"Distance: {value.Distance} - Steps: {value.Steps}");
        }
        ...
        public void PopCountQuestionData()
        {
            ...
            using (new ScopedTimer(this.testOutputHelper))
            {
                answer = solver.Solve(new Data(new[]
                {
            ...
            this.testOutputHelper.WriteLine($"Distance: {answer.Distance} - Steps: {answer.Steps}");
        }
    }
}
